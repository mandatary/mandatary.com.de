...
Sudah pernah saya bahas <QuickView href="/Articles/tentang-nextjs-tailwind-css-dan-framer-motion#tailwind-css">disini</QuickView> (point "Beban ke HTML makin berat").
