...
Halo halo, udah seminggu aja nih semenjak postingan saya yang sebelumnya <QuickView href="/Articles/fitur-multiple-reactions-di-nextjs">Fitur Multiple Reactions</QuickView>.
...
Ini paling penting sih. Sudah support routing out-of-the-box. Bikin dynamic page juga kaya Articles gampang banget.
...
Gampang banget implementasi markdown atau mdx untuk Articlesging menggunakan `@next/mdx`.
...
- **Beban ke HTML makin berat**
  ...
  <div class="nav-link">Articles</div>
  ```
