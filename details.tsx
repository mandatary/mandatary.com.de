...
export const head = {
  title: 'rabツ portfolio',
  description: `Hello! My name is Prabhjyoth, I build web applications, freelance, tutor programming, and live off eating instant ramen 🍜.`,
  keywords: "0xCN, rabツ, Prabhjyoth Mattummal, Freelancer, Web Developer, Cyber Security Enthusiast, Full Stack Developer",
  url: "https://mattummal.com",
  image: "https://mattummal.com/screenshot.png",
...
export const email = "rab@mattummal.com"
...
export const intro = {
  ...
  text: (
    <>
      I'm a data engineer who likes to build digital products and services, alias {' '}
      <NextLink href={'https://github.com/0xCN/'} passHref>
        <Link fontWeight={'600'} textDecoration={'underline'}>rabツ</Link>
      </NextLink>.
...
export const aboutMe = (
  <>
    Hello! My name is <Helper>Prabhjyoth</Helper>, I build web applications, distributed systems, and live off eating instant ramen 🍜.
    <br />
    <br />
